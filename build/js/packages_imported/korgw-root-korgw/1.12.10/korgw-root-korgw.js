(function (root, factory) {
  ...
  var delay_0 = $module$kotlinx_coroutines_core.kotlinx.coroutines.delay_s8cxhz$;
  ...
  GameWindowCoroutineDispatcher.prototype.now = function () {
    return KorgwPerformanceCounter$Companion_getInstance().now();
  };
  GameWindowCoroutineDispatcher.prototype.scheduleResumeAfterDelay_egqmvs$ = function (timeMillis, continuation) {
    var $receiver_0 = numberToDouble(timeMillis);
    this.scheduleResumeAfterDelay_jkl4er$(new KorgwPerformanceCounter(TimeSpan.Companion.fromMilliseconds_14dthe$($receiver_0).microseconds), continuation);
  };
  ...
  GameWindowCoroutineDispatcher.prototype.scheduleResumeAfterDelay_jkl4er$ = function (time, continuation) {
    var task = new GameWindowCoroutineDispatcher$TimedTask(this.now().plus_p8meis$(time), continuation, null);
  ...
  GameWindowCoroutineDispatcher.prototype.invokeOnTimeout_8irseu$ = function (timeMillis, block) {
    var tmp$ = this.now();
    var $receiver_0 = numberToDouble(timeMillis);
    var task = new GameWindowCoroutineDispatcher$TimedTask(tmp$.plus_fv8bff$(TimeSpan.Companion.fromMilliseconds_14dthe$($receiver_0)), null, block);
    this.timedTasks.add_11rb$(task);
  ...
  GameWindowCoroutineDispatcher.prototype.executePending = function () {
    this.executePending_p8meis$(KorgwPerformanceCounter$Companion_getInstance().invoke_fv8bff$(TimeSpan.Companion.fromSeconds_14dthe$(1)));
  };
  GameWindowCoroutineDispatcher.prototype.executePending_p8meis$ = function (availableTime) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    try {
      ...
      while (!this.timedTasks.isEmpty() && startTime.compareTo_11rb$(this.timedTasks.head.time) >= 0) {
        ...
        if (this.now().minus_p8meis$(startTime).compareTo_11rb$(availableTime) >= 0)
          break;
      }
  ...
  function GameWindow() {
    ...
    this.counterTimePerFrame_okejr$_0 = new KorgwPerformanceCounter(0.0);
  ...
  Object.defineProperty(GameWindow.prototype, 'timePerFrame', {
    get: function () {
      return this.counterTimePerFrame.timeSpan;
    }
  });
  Object.defineProperty(GameWindow.prototype, 'fps', {
    ...
    set: function (value) {
      ...
      this.counterTimePerFrame = new KorgwPerformanceCounter(1000000.0 / value_0);
    }
  });
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = delay(this.$this, TimeSpan.Companion.fromMilliseconds_14dthe$(100), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 3:
      ...
      try {
        switch (this.state_0) {
          ...
          case 3:
            ...
            var start = KorgwPerformanceCounter$Companion_getInstance().now();
            this.$this.frame_owbrsl$();
            var elapsed = KorgwPerformanceCounter$Companion_getInstance().now().minus_p8meis$(start);
            var available = this.$this.counterTimePerFrame.minus_p8meis$(elapsed);
            this.state_0 = 4;
            this.result_0 = delay_1(available, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
  ...
  GameWindow.prototype.frame_owbrsl$ = function (doUpdate, startTime) {
    if (doUpdate === void 0)
      doUpdate = true;
    if (startTime === void 0)
      startTime = KorgwPerformanceCounter$Companion_getInstance().now();
    try {
      this.ag.onRender.invoke_11rb$(this.ag);
      this.dispatchRenderEvent_6taknv$(doUpdate);
      if (doUpdate) {
        var elapsed = KorgwPerformanceCounter$Companion_getInstance().now().minus_p8meis$(startTime);
        var available = this.counterTimePerFrame.minus_p8meis$(elapsed);
        this.coroutineDispatcher.executePending_p8meis$(available);
      }} catch (e) {
      if (Kotlin.isType(e, Throwable)) {
  ...
  function EventLoopGameWindow() {
    ...
    this.lastRenderTime = KorgwPerformanceCounter$Companion_getInstance().now();
  }
  ...
  EventLoopGameWindow.prototype.mustPerformRender = function () {
    return this.elapsedSinceLastRenderTime().compareTo_11rb$(this.counterTimePerFrame) >= 0;
  };
  EventLoopGameWindow.prototype.elapsedSinceLastRenderTime = function () {
    return KorgwPerformanceCounter$Companion_getInstance().now().minus_p8meis$(this.lastRenderTime);
  };
  EventLoopGameWindow.prototype.render_6taknv$ = function (doUpdate) {
    this.lastRenderTime = KorgwPerformanceCounter$Companion_getInstance().now();
    this.doInitRender();
    this.frame_owbrsl$(doUpdate, this.lastRenderTime);
    this.doSwapBuffers();
  };
  ...
  function KorgwPerformanceCounter(microseconds) {
    KorgwPerformanceCounter$Companion_getInstance();
    this.microseconds = microseconds;
  }
  Object.defineProperty(KorgwPerformanceCounter.prototype, 'nanoseconds', {
    get: function () {
      return this.microseconds * 1000.0;
    }
  });
  Object.defineProperty(KorgwPerformanceCounter.prototype, 'milliseconds', {
    get: function () {
      return this.microseconds / 1000.0;
    }
  });
  Object.defineProperty(KorgwPerformanceCounter.prototype, 'timeSpan', {
    get: function () {
      return new TimeSpan(this.milliseconds);
    }
  });
  function KorgwPerformanceCounter$Companion() {
    KorgwPerformanceCounter$Companion_instance = this;
  }
  KorgwPerformanceCounter$Companion.prototype.now = function () {
    return new KorgwPerformanceCounter(klock.PerformanceCounter.microseconds);
  };
  KorgwPerformanceCounter$Companion.prototype.invoke_fv8bff$ = function (time) {
    return new KorgwPerformanceCounter(time.microseconds);
  };
  KorgwPerformanceCounter$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var KorgwPerformanceCounter$Companion_instance = null;
  function KorgwPerformanceCounter$Companion_getInstance() {
    if (KorgwPerformanceCounter$Companion_instance === null) {
      new KorgwPerformanceCounter$Companion();
    }return KorgwPerformanceCounter$Companion_instance;
  }
  KorgwPerformanceCounter.prototype.minus_p8meis$ = function (other) {
    return new KorgwPerformanceCounter(this.microseconds - other.microseconds);
  };
  KorgwPerformanceCounter.prototype.plus_p8meis$ = function (other) {
    return new KorgwPerformanceCounter(this.microseconds + other.microseconds);
  };
  KorgwPerformanceCounter.prototype.plus_fv8bff$ = function (other) {
    return new KorgwPerformanceCounter(this.microseconds + other.microseconds);
  };
  KorgwPerformanceCounter.prototype.compareTo_11rb$ = function (other) {
    return Kotlin.compareTo(this.microseconds, other.microseconds);
  };
  KorgwPerformanceCounter.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'KorgwPerformanceCounter',
    interfaces: [Comparable]
  };
  KorgwPerformanceCounter.prototype.unbox = function () {
    return this.microseconds;
  };
  KorgwPerformanceCounter.prototype.toString = function () {
    return 'KorgwPerformanceCounter(microseconds=' + Kotlin.toString(this.microseconds) + ')';
  };
  KorgwPerformanceCounter.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.microseconds) | 0;
    return result;
  };
  KorgwPerformanceCounter.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.microseconds, other.microseconds))));
  };
  function max_0(a, b) {
  ...
  function delay$lambda(closure$dispatcher, closure$time) {
    return function (cont) {
      closure$dispatcher.scheduleResumeAfterDelay_jkl4er$(closure$time, cont);
      return Unit;
    };
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            if (this.local$time.microseconds <= 0) {
              return;
            } else {
              this.state_0 = 2;
              continue;
          ...
          case 2:
            ...
            if (dispatcher != null) {
              ...
              this.state_0 = 3;
              this.result_0 = delay_0(Kotlin.Long.fromNumber(this.local$time.milliseconds), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function delay_1(time_0, continuation_0, suspended) {
  ...
  function BrowserGameWindow_init$lambda_16(this$BrowserGameWindow) {
    return function (step) {
      var startTime = KorgwPerformanceCounter$Companion_getInstance().now();
      ...
      try {
        ...
        var elapsed = KorgwPerformanceCounter$Companion_getInstance().now().minus_p8meis$(startTime);
        var available = this$BrowserGameWindow.counterTimePerFrame.minus_p8meis$(elapsed);
        this$BrowserGameWindow.coroutineDispatcher.executePending_p8meis$(available);
      }
      return Unit;
    };
  }
  ...
  Object.defineProperty(KorgwPerformanceCounter, 'Companion', {
    get: KorgwPerformanceCounter$Companion_getInstance
  });
  package$korgw.KorgwPerformanceCounter = KorgwPerformanceCounter;
  package$korgw.max_s8mnjg$ = max_0;
  package$korgw.min_s8mnjg$ = min;
  package$korgw.delay_p8meis$ = delay_1;
